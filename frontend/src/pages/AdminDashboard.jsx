          ...
          <div style={{ height: 260, marginTop: '1rem' }}>
            <ResponsiveContainer width="100%" height="100%">
              <BarChart data={weeklyActivity} margin={{ top: 10, right: 10, left: -25, bottom: 0 }}>
                ...
                <Bar dataKey="tasksCompleted" name="Tasks Completed" fill="#00A884" radius={[4, 4, 0, 0]} />
                <Bar dataKey="aiQueries" name="AI RAG Queries" fill="#0284C7" radius={[4, 4, 0, 0]} />
              </BarChart>
            </ResponsiveContainer>
          </div>
        </div>
                ...
                <div style={{ width: '100%', height: '8px', background: '#F1F5F9', borderRadius: 999, overflow: 'hidden' }}>
                  <div
                    style={{
                      width: `${cat.completed}%`,
                      height: '100%',
                      background: 'linear-gradient(90deg, #0284C7 0%, #00A884 100%)',
                      borderRadius: 999
                    }}
                  />
                </div>
